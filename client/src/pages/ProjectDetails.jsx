    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Creador</h4>
          ...
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Gente que cree en este proyecto:</h4>
